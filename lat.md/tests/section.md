...
`formatSectionOutput` produces markdown containing the section id, location, raw content, "This section references" with outgoing ref ids, and "Referenced by" with incoming ref ids.
